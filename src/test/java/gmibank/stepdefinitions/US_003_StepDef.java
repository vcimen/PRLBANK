...
public class US_003_StepDef {
    ...
    String color =us_003_page.line1.getCssValue("background-color");
        System.out.println(color);
        Assert.assertTrue(color.contains(ConfigurationReader.getProperty("red")));
    Driver.wait(2);
    }
    ...
    public void user_enters_to_second_text_box_with_lowercase_letter_of_at_least_characters(Integer int1, Integer int2) {
        ...
        Driver.wait(2);
        Assert.assertFalse(us_003_page.confirmationWritting.isDisplayed());
    ...
    String color = us_003_page.line2.getCssValue("background-color");
        System.out.println(color);
        Assert.assertTrue(color.contains(ConfigurationReader.getProperty("red")));
    Driver.wait(2);
    }
   ...
   // Driver.getDriver().navigate().refresh();
    ...
    String color = us_003_page.line3.getCssValue("background-color");
        System.out.println(color);
        Assert.assertTrue(color.contains(ConfigurationReader.getProperty("orange")));
    Driver.wait(2);
    }
    ...
    String color = us_003_page.line4.getCssValue("background-color");
        System.out.println(color);
        Assert.assertTrue(color.contains(ConfigurationReader.getProperty("green")));
    Driver.wait(2);
    }
